    ...
    return (
        <Box ref={ref} className="section-container intro">
            ...
            <motion.div initial="hidden" animate={isInView ? "visible" : "hidden"} variants={bottomFadeUp} custom={0.2}>
                <Typography textAlign="center" color="text.secondary">Hi, I am Nihal. I am a final semester Computer Science student who enjoys playing with tools and technologies. I help solving real world problems by building technical Products. Feel free to leave a message!</Typography>
            </motion.div>
